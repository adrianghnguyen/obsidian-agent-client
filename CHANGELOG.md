...
### Changed
- **Voice input** — While recording, the mic button turns red and the icon becomes a live wave. Hover it to reveal a stop square, then click to stop. Enter or the composer send button still sends the dictation.
