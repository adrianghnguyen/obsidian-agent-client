...
### Changed
- **Voice input** — While recording, the mic stays in place, turns red, and shows a live wave inside the icon. Hover the mic and click to stop. Enter or the composer send button still sends the dictation.
