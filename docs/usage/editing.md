...
In **Settings → Agent Client → Behavior → Auto-allow permissions**, you can automatically allow all permission requests from agents.
...
Configure these in **Settings → Agent Client → Appearance**.
